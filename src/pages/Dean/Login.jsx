...
import { loginDean } from '../../api/auth';
...
function Login() {
  ...
  useEffect(() => {
    const savedData = getSavedFormData('deanLoginForm');
    if (savedData) {
  ...
  useFormPersistence('deanLoginForm', formDataState);
  useClearFormOnUnmount('deanLoginForm');

  useEffect(() => {
    document.title = 'CTU Portal | Dean Login';
  }, []);
  ...
  useEffect(() => {
    ...
    try {
      ...
      if (parsed?.target === 'dean' && parsed?.message) {
  ...
  const handleSendReset = async () => {
    ...
    const redirectTo = `${window.location.origin}/dean/login`;
    ...
    try {
      ...
      if (error) {
        ...
        setTimeout(async () => {
          ...
          window.history.replaceState(null, '', '/dean/login');
  ...
  const handleSubmit = async (e) => {
    ...
    const result = await loginDean({ email, password });
        ...
        <div className="grid md:grid-cols-2">
          ...
          <div className="p-8 md:p-8 bg-white/95">
            <div className="flex flex-col items-center text-center mb-6">
              ...
              <h2 className="text-xl font-semibold text-slate-900">Dean Login</h2>
              ...
              <div className="text-center pt-2">
                <p className="text-xs md:text-sm text-slate-600">
                  ...
                  <button
                    ...
                    tabIndex={0}
                    onClick={() => navigate('/dean/register')}
