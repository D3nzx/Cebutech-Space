...
import { loginStudent } from '../../api/studentAuth';
...
function StudentLogin() {
  ...
  useEffect(() => {
    const savedData = getSavedFormData('studentLoginForm');
    if (savedData) {
      console.log('♻️ Restoring Student Login form data on mount');
  ...
  useFormPersistence('studentLoginForm', formDataState);
  useClearFormOnUnmount('studentLoginForm');

  useEffect(() => {
    document.title = 'CTU Portal | Student Login';
  }, []);
  ...
  useEffect(() => {
    ...
    try {
      ...
      if (parsed?.target === 'student' && parsed?.message) {
  ...
  return (
    <div className="min-h-screen w-full bg-gradient-to-br from-slate-900 via-slate-950 to-black flex items-center justify-center px-4 py-6">
      <div className="w-full max-w-2xl bg-white/5 border border-white/10 rounded-3xl shadow-2xl backdrop-blur-xl overflow-hidden outline-none focus:outline-none">
        <div className="grid md:grid-cols-2 outline-none focus:outline-none">
          <div className="p-8 md:p-8 text-white bg-gradient-to-br from-red-800 via-red-600 to-orange-400 pointer-events-none select-none" aria-hidden="true">
          </div>

          <div className="p-8 md:p-8 bg-white/95 select-none">
        ...
        <div className="fixed inset-0 bg-black/60 backdrop-blur-sm flex items-center justify-center z-50">
          <div className="bg-white/95 border border-white/10 rounded-3xl shadow-2xl p-8 w-full max-w-sm backdrop-blur-xl">
            ...
            <div className="flex gap-3 mt-6">
              <button 
                className="flex-1 px-4 py-3 bg-[#4285F4] text-white rounded-2xl font-semibold shadow-lg shadow-[#4285F4]/30 hover:shadow-2xl hover:bg-[#357AE8] transition disabled:opacity-60" 
        ...
        <div className="fixed inset-0 bg-black/60 backdrop-blur-sm flex items-center justify-center z-50">
          <div className="bg-white/95 border border-white/10 rounded-3xl shadow-2xl p-8 w-full max-w-sm backdrop-blur-xl">
            ...
            <form onSubmit={handleRecoverySubmit} className="space-y-4">
              ...
              <button
                type="submit"
                className="w-full py-3 px-4 bg-[#4285F4] text-white rounded-2xl font-semibold shadow-lg shadow-[#4285F4]/30 hover:shadow-2xl hover:bg-[#357AE8] focus:outline-none focus:ring-2 focus:ring-blue-400 transition disabled:opacity-60 text-sm"
