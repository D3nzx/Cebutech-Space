...
import { LayoutDashboard, Calendar, BookMarked } from 'lucide-react';

function StudentSidebar({ isOpen, onClose, isCollapsed = false, activeSection, onSectionChange, isMobile = false, studentData, user }) {
  const navItems = [
