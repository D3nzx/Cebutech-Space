...
function StudentSettings({ user, studentData, onDataSaved = () => {} }) {
      ...
      try {
        ...
        if (error) {
          if (error.code === 'PGRST116') {
            console.warn('Student record not found, allowing form with empty data');
            setStudent(null);
            const emptyFormData = {
              first_name: '',
              middle_name: '',
            ...
            <div className="pt-6 border-t border-slate-200">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                  ...
                  <div className="relative">
                    <div className="w-full px-4 py-2.5 border border-slate-300 rounded-lg bg-slate-50 text-slate-600 pr-12">
                      {showEmail ? (user?.email || 'Not available') : '••••••••••••••••'}
                    </div>
                    <button
                      type="button"
                ...
                <div>
                  ...
                  <div className="relative">
                    <div className="w-full px-4 py-2.5 border border-slate-300 rounded-lg bg-slate-50 text-slate-600 pr-12">
                      {showStudentId ? (student?.student_id || 'Not available') : '•••••••'}
                    </div>
                    <button
                      type="button"
                      ...
                      className="absolute inset-y-0 right-3 flex items-center text-slate-500 bg-transparent hover:text-slate-700 transition-colors p-0 border-none shadow-none focus:outline-none"
                      tabIndex={-1}
                      aria-label={showStudentId ? 'Hide ID' : 'Show ID'}
                    >
                      {showStudentId ? <Eye size={18} /> : <EyeOff size={18} />}
                    </button>
                  </div>
                ...
                <div>
                  ...
                  <p className="mt-1 text-xs text-slate-500">Current year level</p>
                </div>
                ...
                <div>
                  ...
                  <p className="mt-1 text-xs text-slate-500">Current section</p>
                </div>
              </div>
            </div>
